...
cv2.createTrackbar('Value1','image',11,255,nothing)
cv2.createTrackbar('Value2','image',2,255,nothing)
cv2.createTrackbar('Value3','image',255,255,nothing)
cv2.createTrackbar('Value4','image',255,255,nothing)
...
while(1):
	...
	th2 = cv2.adaptiveThreshold(gray,v3,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,\
